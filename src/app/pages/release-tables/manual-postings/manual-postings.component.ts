...
@Component({
  selector: 'app-manual-postings',
  templateUrl: './manual-postings.component.html',
  styleUrls: ['./manual-postings.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ManualPostingsComponent implements AfterViewInit {
...
@NgModule({
  ...
  exports: [ManualPostingsComponent],
})
export class ManualPostingsComponentModule { }