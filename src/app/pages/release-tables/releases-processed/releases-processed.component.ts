...
@Component({
  selector: 'app-releases-processed',
  templateUrl: './releases-processed.component.html',
  styleUrls: ['./releases-processed.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReleasesProcessedComponent implements AfterViewInit {
...
@NgModule({
  ...
  exports: [ReleasesProcessedComponent],
})
export class ReleasesProcessedComponentModule { }